...
export default function LoginDialog({ onClose, onShowReset, onLoginSuccess }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("https://citizenloop.onrender.com/api/users/login", { email, password });
      setStep("otp");
      setErrors({});
    } catch (err) {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("https://citizenloop.onrender.com/api/users/verify-otp", { email, otp });
  ...
  const handleResendOtp = async () => {
    try {
      await axios.post("https://citizenloop.onrender.com/api/users/resend-otp", { email });
